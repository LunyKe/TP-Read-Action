...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 ">
    ...
    <div>
        <button type="submit" class="flex w-full justify-center rounded-md bg-amber-950 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
    </div>
</form>

<p class="mt-10 text-center text-sm/6 text-gray-500">
    Don't have account?
    <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Create here</a>
</p>
</div>
</div>
</div>
